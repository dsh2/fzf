...
fzf-history-widget() {
  ...
  selected=( $(fc -lEDt '%a %F %T' 1 | $(__fzfcmd) +s --tac +m -n4..,.. --preview 'echo {} | pygmentize -l zsh' --preview-window up:3:wrap --tiebreak=index --toggle-sort=ctrl-r ${=FZF_CTRL_R_OPTS} -q "${LBUFFER//$/\\$}") )
